#!/usr/bin/env bash
# PROMOVER dev -> prod ("PR a producción").
# 1) merge dev en main  2) apaga dev  3) enciende prod  4) actualiza módulos.
# NO toca Traccar.
set -e
cd "$(dirname "$0")/.."
...
echo "==> PROMOCIÓN COMPLETA. PROD en :8090 con los cambios de dev. DEV dormido. Traccar intacto."
